import { Image, Text, TouchableOpacity, View, StyleSheet, FlatList, TextInput } from 'react-native'
...
const VideoView = () => {
    ...
    const [videoImageData, setVideoImageData] = useState<any>([]);
    ...
    const getMedia = async () => {
        const videoItem = await AsyncStorage.getItem('selected_video') as any;
    ...
    const sharedMedia = async () => {
        ...
        const payload = { mid: mid, uid: uid, typeoffile: videoData.type }
    ...
    const archive = async (videoData: any) => {
    ...
    return (
        <View style={styles.container}>
            <Video
                source={{ uri: videoImageData.youtube }}
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center' }} >
                ...
                <TouchableOpacity onPress={() => archive(videoData)} >
            ...
            <Dialog visible={modalVisible} style={{ zIndex: 10, marginTop: 10, margin: 60 }} >
                <View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'flex-end', marginRight: '10%', marginBottom: 20 }}>
                        ...
                        <TouchableOpacity onPress={() => share(videoData)}>
            ...
            <Dialog visible={shareDialog} style={{ zIndex: 10, marginTop: 10, margin: 60 }} >
                <View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'flex-end', marginRight: '10%', marginBottom: 20 }}>
                        ...
                        <TouchableOpacity onPress={() => acceptShare(videoData)}>
            ...
            <Dialog visible={archiveVisible} style={{ zIndex: 10, marginTop: 10, margin: 60 }} >
                <View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'flex-end', marginRight: '10%', marginBottom: 20 }}>
                        ...
                        <TouchableOpacity onPress={() => Archived(videoData)}>
                            <Text style={styles.closeButton}>OK</Text>
                        </TouchableOpacity>
                    </View>
